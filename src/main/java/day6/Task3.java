package day6;
/**
 *  Создать класс Teacher (Преподаватель), имеющий поля “Имя”, “Предмет”. Создать класс Student (Студент)
 *  с полем “Имя”.
 ...
 * значения случайно сгенерированного числа.
 *
...
public class Task3 {
    public static void main(String[] args) {
            Teacher teacher = new Teacher("Tob", "music");
